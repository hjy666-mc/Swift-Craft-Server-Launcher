...
enum ModrinthDependencyDownloader {
    ...
    static func downloadMainResourceOnly(
        ...
        mainProjectVersionId: String? = nil
        ...
        do {
            ...
            let targetVersion: ModrinthProjectDetailVersion?
            if let mainProjectVersionId {
                targetVersion = filteredVersions.first { $0.id == mainProjectVersionId }
            } else {
                targetVersion = filteredVersions.first
            }
