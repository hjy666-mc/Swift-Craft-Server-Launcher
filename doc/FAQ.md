...
### ❓ SwiftCraftServerLauncher 是什么？

SwiftCraftServerLauncher 是一个使用 Swift 编写的 Minecraft 启动器项目，主要用于学习、开发和社区交流。
...
A：在终端执行`defaults delete com.su.code.SwiftCraftServerLauncher savedPlayers` 后重启启动器即可
